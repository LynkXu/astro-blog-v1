...
fn main() {
    ...
    let mut reviews: HashMap = HashMap::new();
...
while counter `枚举，用于处理可能存在或者可能为空的值。
...
fn safe_division(dividend: f64, divisor: f64) -> Result {
    if divisor == 0.0 {
